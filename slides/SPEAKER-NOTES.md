...
**Keys:** `←` `→` or space · `N` notes · `P` print / PDF

---

## 1. Beyond the prompt.

`CGP · Recruitment · Business Development · Operations`
...
**→ "Before I answer that — here's why it matters to the company, not just to you."**
...
**On screen:** Your prompts are fine. They're just disposable.

- **The leadership slide.** If a director remembers one thing, this is it.
- **How both are true:** "Forty people save two hours a week. That's eighty hours — into forty separate inboxes. The time was real. It just evaporated."
- **Take the pressure off:** "You're already good at asking. Tuesday's great prompt is just buried by Thursday, your colleague redoes it next week, and we can't show a client what the AI was told."
- **Kill the tool question early:** "Competitors have the same tools. Nobody's winning because of the tool."
- *Sources: Microsoft 2026, 20,000 people · study of 6,000 executives.*

**→ "So what do we actually do about it? I promised you an answer — here it is."**
...
- **Where:** one file everyone can open and edit, that keeps a history of who changed what and when. Not an inbox, not a personal drive.
- *If you mention the repository, gloss it once: "a shared folder online that remembers every version. You don't need to understand how it works to use it — you click a file and read it."*
...
**→ "Sharing prompts is the first of four levels. Here's the whole map, so you know where we're going."**
...
**On screen:** Asking well

- **Point at the strip along the top** — it lights up to show which level we're on.
- *The strip uses one-word labels: prompt, context, loop, graph. Say the plain version each time — "context just means the material you give it" — so nobody is decoding vocabulary while you talk.*
- **New-colleague analogy** covers all four: L1 asking them to do something · L2 handing them the file and template first · L3 them doing it and checking before bringing it to you · L4 a proper process with sign-offs.
- **They stack.** "A weak prompt inside an automated system is still weak — it just produces bad work faster, with nobody watching."
- **Be honest:** "We're at level 1. Most companies are. Fine — if we start climbing."
- *If asked: levels 3 and 4 need no coding. Level 3 starts with a checklist.*

**→ "Let's start with level two, because it's the quickest win and it costs nothing."**
...
- **Warm up:** "Who's asked AI to summarise a CV and got back something that sounded fine but told you nothing?" Most hands. "That's not weak AI — you never told it what good looks like."
...
**→ "Good material still means you're driving every single step. Next: how it starts driving itself."**
...
- **Define it first:** "A loop is when AI does a job, checks its own work against your rules, fixes what's wrong, and only comes to you when it's done or stuck."
- **Laundry gets a laugh** and makes the shape obvious — nobody would run a machine with no way to tell if the clothes came out clean. Most AI workflows skip exactly that.
...
**→ "Look at part three — the check. That's the part everyone skips, and here's why it matters."**
...
**On screen:** Turn checks into yes/no facts. Facts don't need trusting.
...
**→ "You might think one weak check isn't a big deal. Let me show you what happens when they stack up."**
...
- **Most important slide. Slow down.**
- **Human example first, before the numbers:** "A CV is entered with the wrong notice period. Nobody catches it. It flows into the shortlist, the submission, the scheduling, the offer. Five things wrong from one small mistake." Everyone's lived it.
...
**→ "That's the maths. Here's the one habit that fixes the most common version of it, today."**
...
- **Why it happens:** "A chat is one long document and the AI re-reads all of it every time. After four failures, those four wrong answers are still on the page. It's reading its own mistakes as reference material. You made it worse by trying harder."
...
**→ "A fresh chat fixes confusion. But there's a second thing that goes wrong, and it's the bigger one."**
...
**On screen:** Keep one living file. Chats forget. Files don't.

- **Walk the week day by day.** The example does the work — don't rush it.
- **Land it:** "Everything it did was reasonable based on what it knew. The problem was what it *didn't* know. Not a stupidity problem — a bookkeeping problem." Then point at the 60%.
...
**→ "One thing before any of this touches real candidate or client data."**
...
- **Make reporting safe — say it out loud:** "Pasted something you shouldn't have? Tell your manager and the Data Protection Officer the same day. Reporting a mistake is never a disciplinary matter. Hiding one is." *Use the full title, not "DPO".*
...
**→ "Let me leave you with a single question to take away."**
...
*Generated from `slides/index.html`. Edit the deck, not this file.*